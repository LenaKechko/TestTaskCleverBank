...
public class AccountDAO extends AbstractDAO<Integer, Account> {
    ...
    public static final String SQL_SELECT_ACCOUNT_USER = "SELECT number_account FROM accounts " +
            "WHERE id_user = (SELECT id FROM users WHERE lastname = ? and name = ? and middlename = ?)";

    public static final String SQL_SELECT_ACCOUNT_BANK = "SELECT number_account FROM accounts " +
    ...
    public boolean create(Account account) {
        try (Connection connection = ConnectorDB.getConnection();
            ...
            preparedStatement.setDate(2, (Date) account.getOpeningDate());
    ...
    public boolean update(Account account) {
        try (Connection connection = ConnectorDB.getConnection();
            ...
            preparedStatement.setDate(1, (Date) account.getOpeningDate());
